...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/rates")]
    public partial class Rates : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 48 "F:\Blazor\GestionTelefonos\GestionTelefonos\Client\Pages\Rates.razor"
    ...
    async Task Grid_EditModelSaving(GridEditModelSavingEventArgs e) {
        ...
        if (e.IsNew)
            await rateService.insertRateAsync(rate);
        else
            await rateService.updateRateAsync(rate);
    ...
    async Task Grid_DataItemDeleting(GridDataItemDeletingEventArgs e) {
        ...
        await rateService.deleteRateAsync(rate.ID);
